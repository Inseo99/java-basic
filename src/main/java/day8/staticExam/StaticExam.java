...
public class StaticExam {
    public static void main(String[] args) {
        ...
        // 클래스와 객체를 만드는 이유. 같은 구조인데 서로 다른 정보를 갖게 하기 위함.
        ...
        // 인류 평균 나이 81로 정정
        p1.avgAge = 81;
        p1.printAvgage(); // static 붙이기 전 : p1의 인류 평균 나이는 81로 수정되어 출력됨. 붙인 후 : 81로 수정되어 출력됨
        p2.printAvgage(); // static 붙이기 전 : p2의 인류 평균 나이는 여전히 80으로 출력됨. 붙인 후 : 81로 수정되어 출력됨
        ...
        // 가지고 있는 변수를 사용하지 않는 경우에나 static을 붙여야 한다.
